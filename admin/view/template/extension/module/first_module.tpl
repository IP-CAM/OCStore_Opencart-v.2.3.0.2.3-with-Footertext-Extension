      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-first-module" class="form-horizontal">
          <div class="form-group">
            ...
            <div class="col-sm-10">
               <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-description<?php echo $language['language_id']; ?>">Text in footer:</label>
                    <div class="col-sm-10">
                      <textarea name="out_text" placeholder="" class="form-control summernote"><? echo $footertext; ?></textarea>
                    </div>
                  </div>
            </div>
          </div>
